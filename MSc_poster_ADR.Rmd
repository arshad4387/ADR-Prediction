...
<<<<<<< HEAD
    affil: 
=======
>>>>>>> d63ef35872443e689156e15c694db1783f55380d
affiliation:
  - num: 1
...
ggplot(drug_burden, aes(x = n)) +
  ...
  labs(title = "Distribution of ADR Counts per Drug",
       x = "Number of Adverse Drug Reactions",
       y = "Number of Drugs") +
  theme_minimal()
>>>>>>> d63ef35872443e689156e15c694db1783f55380d
...
# Acknowldgement
We would like to thank Dr. Yezhao and Dr. Haixuan for their and sharing the code and data through the github page. 
