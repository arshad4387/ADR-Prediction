...
kable(auroc_table, caption = "Mean AUROC across five-fold cross-validation for all methods")
```
...
kable(aupr_table, caption = "Mean AUPR across five-fold cross-validation for all methods")
```
